...
class ChangeEmployee extends Component {
    constructor() {
        super();
        this.state = {
            name: '',
    ...
    handleSubmit(evt) {
        ...
        axios.post("http://localhost:8080/api/change_employee", employee,
    ...
    render() {
        ...
        <div className="">
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <input type="submit" value="Редактировать информацию о сотруднике"
               data-test="submit" />
            </form>
            <br/>
            <h3>########################################</h3>
            <button onClick = {() =>{
                ...
                axios.post("http://localhost:8080/api/delete_employee", employee,
                    { headers: {  "Content-Type": "application/json"}})
                }}>
                 Удалить сотрудника
            </button>
